...
Enables the ribbon resize feature.allowResizing is a deprecated property of [`isResponsive`](http://help.syncfusion.com/js/api/ejribbon#members:isresponsive). 
